...
- [ ] add musicbrainz_id to track object (or to track_source, that should then be named track_ref instead, with a unique constraint on composite platform + id, and do the same for album and artists)
